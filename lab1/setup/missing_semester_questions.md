...
8. What does the following command sequence do?
    ...
    - [x] c) in any file with a `:` character on any line, it replaces any occurrence of `heck` with `fluff`
...
9. What does the following command sequence do?
    ...
    - [x] d) finds each flagged file in this directory and replaces occurrences of `Linux` with `GNU/Linux`
